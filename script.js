...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.skill-category, .project-card, .stat, .section-title');
...
console.log('%c🚀 Christopher Corbin Portfolio', 'color: #ff9900; font-size: 20px; font-weight: bold;');
console.log('%cBuilt with ❤️ using HTML, CSS, JavaScript and deployed on AWS S3', 'color: #666; font-size: 12px;');
console.log('%cInterested in the code? Check it out on GitHub!', 'color: #146eb4; font-size: 12px;');